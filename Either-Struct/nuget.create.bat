...
nuget pack Either-Struct.csproj -Prop Configuration=Release -Prop Platform=AnyCPU
nuget pack Either-Struct.csproj -Prop Configuration=Release -Prop Platform=AnyCPU -Symbols
